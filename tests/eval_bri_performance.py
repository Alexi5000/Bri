...
class BRIEvaluator:
    ...
    def get_test_cases(self) -> list[EvalTestCase]:
        ...
        scene_tests = [
            ...
            EvalTestCase(
                2,
                "test_video",
                "Describe what you see at the beginning",
            ...
            EvalTestCase(
                3,
                "test_video",
                "What's the main action in this video?",
                ["action", "main", "doing"],
                "scene",
                "medium",
            ),
            ...
            EvalTestCase(
                5,
                "test_video",
                "What changes happen throughout the video?",
            ...
            EvalTestCase(
                7,
                "test_video",
                "Describe the lighting and colors",
                ["lighting", "color", "bright", "dark"],
                "scene",
                "medium",
            ),
            EvalTestCase(
        ...
        object_tests = [
            ...
            EvalTestCase(
                ...
                ["electronic", "device", "phone", "computer"],
                "object",
                "medium",
            ),
            EvalTestCase(
            ...
            EvalTestCase(
                22,
                "test_video",
                "Are there any tools or equipment?",
            ...
            EvalTestCase(
                24,
                "test_video",
                "Are there any plants or nature elements?",
                ["plant", "nature", "tree", "flower"],
                "object",
                "easy",
            ),
            EvalTestCase(
        ...
        audio_tests = [
            ...
            EvalTestCase(
                27,
                "test_video",
                "Can you transcribe what you hear?",
                ["transcribe", "hear", "audio"],
                "audio",
                "medium",
            ),
            EvalTestCase(
            ...
            EvalTestCase(
                29,
                "test_video",
                "What's the last thing mentioned?",
                ["last", "end", "final"],
                "audio",
                "medium",
            ),
            ...
            EvalTestCase(
                34,
                "test_video",
                "Is there any laughter or emotion?",
                ["laughter", "emotion", "feeling"],
                "audio",
                "hard",
            ),
            EvalTestCase(
        ...
        timestamp_tests = [
            ...
            EvalTestCase(
                39,
                "test_video",
                "When does the main action occur?",
                ["when", "time", "moment"],
                "timestamp",
                "medium",
            ),
            ...
            EvalTestCase(
                41,
                "test_video",
                "How long does the main scene last?",
        ...
        general_tests = [
            ...
            EvalTestCase(
                47,
                "test_video",
                "Is this educational or entertainment?",
                ["educational", "entertainment", "type"],
                "general",
                "medium",
            ),
            EvalTestCase(
                48,
                "test_video",
                "What genre or category is this?",
                ["genre", "category", "type"],
                "general",
                "medium",
            ),
    ...
    def generate_report(self) -> dict[str, Any]:
        ...
        avg_response_time = (
            sum(r.response_time for r in self.results) / total_tests if total_tests > 0 else 0
        )
        ...
        for diff in difficulties:
            difficulties[diff]["avg_score"] = (
                difficulties[diff]["score"] / difficulties[diff]["total"]
            )
    ...
    def print_summary(self, report: dict[str, Any]):
        ...
        for cat, stats in report["by_category"].items():
            print(
                f"  {cat.upper()}: {stats['passed']}/{stats['total']} passed ({stats['pass_rate']:.1%}) | Avg Score: {stats['avg_score']:.2f}"
            )

        print("\nBy Difficulty:")
        for diff, stats in report["by_difficulty"].items():
            print(
                f"  {diff.upper()}: {stats['passed']}/{stats['total']} passed ({stats['pass_rate']:.1%}) | Avg Score: {stats['avg_score']:.2f}"
            )
