    ...
    def test_object_detection_transformation(self):
        ...
        detection_data = {
            ...
            "objects": [
                ...
                {"class_name": "car", "confidence": 0.88, "bbox": [300, 400, 150, 80]},
            ],
        }
...
class TestChaosEngineering:
    ...
    def test_extreme_values_handling(self):
        ...
        extreme_frame = {"timestamp": 999999999.0, "frame_number": 999999999}
        ...
        extreme_caption = {"frame_timestamp": 1.0, "text": "Test", "confidence": 0.001}
