...
class TestMemoryHelperMethods:
    ...
    def test_get_recent_context(self, memory):
        ...
        memory.add_memory_pair("vid_001", "What's happening?", "I see a person walking.")
        memory.add_memory_pair(
            "vid_001", "What are they wearing?", "They're wearing a blue jacket."
        )
    ...
    def test_get_recent_context_with_limit(self, memory):
        ...
        for i in range(3):
            memory.add_memory_pair("vid_001", f"Question {i}", f"Answer {i}")
