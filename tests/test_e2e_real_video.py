...
class TestE2ERealVideo:
    ...
    def test_video_has_transcript(self, db, real_video_id):
        ...
        if transcript_count == 0:
            pytest.skip(
                f"No transcript found for video {real_video_id}; fixture DB lacks audio data"
            )
    ...
    async def test_50_queries(self, agent, real_video_id):
        ...
        for i, query_data in enumerate(test_queries, 1):
            ...
            try:
                ...
                results.append(
                    {"query": query, "passed": success, "response_length": len(response.message)}
                )
    ...
    def _get_test_queries(self) -> list[dict[str, Any]]:
        ...
        return [
            ...
            # Temporal/Timing (10)
            {
                "query": "What happens at the beginning?",
            ...
            {
                "query": "What is being communicated?",
                "keywords": ["communicate", "video", "message"],
            },
