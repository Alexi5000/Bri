...
class FileStore:
    ...
    def validate_video_file(self, filename: str, file_size: int) -> tuple[bool, str | None]:
        """
    ...
    def save_uploaded_video(
        self, file_data: BinaryIO, original_filename: str, video_id: str | None = None
    ) -> tuple[str, str]:
        """
    ...
    def save_frame(
        self, video_id: str, frame_data: bytes, timestamp: float, frame_number: int
    ) -> str:
        """
