...
class ArchivalManager:
    ...
    def permanently_delete_video(self, video_id: str, delete_files: bool = True) -> bool:
        ...
        try:
            ...
            video = self.db.execute_query("SELECT * FROM videos WHERE video_id = ?", (video_id,))
    ...
    def get_retention_policy_status(self) -> dict[str, Any]:
        ...
        try:
            ...
            # Count total records
            stats["total_videos"] = self.db.execute_query("SELECT COUNT(*) as count FROM videos")[
                0
            ]["count"]
            stats["total_memory"] = self.db.execute_query("SELECT COUNT(*) as count FROM memory")[
                0
            ]["count"]
            stats["total_context"] = self.db.execute_query(
    ...
    def apply_retention_policies(
        ...
        results["archived_conversations"] = self.archive_old_conversations(
            archive_conversations_days
        )
