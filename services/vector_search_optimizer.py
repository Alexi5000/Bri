...
class QueryCache:
    ...
    def get(self, query: str, video_id: str | None = None, top_k: int = 5) -> list[Any] | None:
    ...
    def put(
        self, query: str, results: list[Any], video_id: str | None = None, top_k: int = 5
    ) -> None:
        """Cache query results.
    ...
    def invalidate(self, video_id: str | None = None) -> None:
        ...
        if video_id is None:
            ...
            keys_to_remove = [key for key in self.cache.keys() if video_id in key]
...
class VectorSearchOptimizer:
    ...
    def __init__(self, enable_cache: bool = True, cache_size: int = 1000, cache_ttl: int = 3600):
    ...
    def get_performance_stats(self) -> dict[str, Any]:
        ...
        """
        stats = {"cache_enabled": self.enable_cache, "total_queries": len(self.query_times)}
        ...
        if self.query_times:
            ...
            stats["query_times"] = {
                ...
                "p95_ms": statistics.quantiles(self.query_times, n=20)[18] * 1000
                if len(self.query_times) > 20
                else None,
                "p99_ms": statistics.quantiles(self.query_times, n=100)[98] * 1000
    ...
    def recommend_optimizations(self, stats: dict[str, Any]) -> list[str]:
        ...
        if "query_times" in stats:
            ...
            if avg_ms < 50:
                recommendations.append(f"Excellent query performance ({avg_ms:.1f}ms average)!")
    ...
    def ab_test_search_quality(
        ...
        for test in test_queries:
            ...
            results_a.append({"precision": precision_a, "recall": recall_a, "f1": f1_a})
            ...
            results_b.append({"precision": precision_b, "recall": recall_b, "f1": f1_b})
        ...
        if metric == "precision":
            ...
            improvement = abs(avg_precision_a - avg_precision_b) / max(
                avg_precision_a, avg_precision_b
            )
        elif metric == "recall":
