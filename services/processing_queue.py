...
class ProcessingQueue:
    ...
    def __init__(self, max_concurrent_jobs: int = 2):
        ...
        # Locks for coroutine mutation and cross-thread status snapshots.
    ...
    async def get_next_job(self) -> ProcessingJob | None:
        ...
        async with self.lock:
            ...
            # Get highest priority job (first in sorted list) and move it
    ...
    async def complete_job(
        ...
        async with self.lock:
            ...
            # Update and move job atomically for readers that poll status
