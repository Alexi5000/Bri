...
class GracefulDegradationService:
    ...
    def get_data_with_fallback(
        self, primary_fetch: Callable, cache_key: str | None = None, video_id: str | None = None
    ) -> Any | None:
    ...
    def build_partial_response(
        self, video_id: str, available_data: dict[str, Any], missing_data: list[str]
    ) -> dict[str, Any]:
    ...
    def queue_request(
        self, request_type: str, request_data: dict[str, Any], video_id: str | None = None
    ) -> str:
        ...
        with LogContext(video_id=video_id, queue_id=queue_id):
            ...
            self._log_degradation_event(
                "request_queue", f"Queued {request_type} request", mode=DegradationMode.QUEUED
            )
    ...
    def handle_groq_api_failure(
        self, query: str, video_id: str, error: Exception
    ) -> dict[str, Any]:
        ...
        with LogContext(video_id=video_id):
            ...
            queue_id = self.queue_request("chat", {"query": query, "video_id": video_id}, video_id)
    ...
    def _log_degradation_event(
        self, service: str, reason: str, mode: DegradationMode | None = None
    ):
