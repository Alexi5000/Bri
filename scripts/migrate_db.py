...
def main():
    ...
    parser = argparse.ArgumentParser(description="Database migration tool for BRI video agent")
    ...
    migrate_parser.add_argument(
        "--to", type=int, dest="target_version", help="Target version to migrate to"
    )

    # Rollback command
    rollback_parser = subparsers.add_parser("rollback", help="Rollback migrations")
    rollback_parser.add_argument(
        "--to", type=int, dest="target_version", help="Target version to rollback to"
    )
    rollback_parser.add_argument(
