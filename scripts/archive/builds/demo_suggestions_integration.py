...
def demo_suggestion_flow():
    ...
    for scenario in scenarios:
        ...
        for i, turn in enumerate(scenario["conversation"], 1):
            ...
            suggestions = agent._generate_suggestions(turn["user"], turn["bri"], "demo_video_id")
            ...
            if i < len(scenario["conversation"]):
                ...
                for suggestion in suggestions:
                    if (
                        suggestion.lower() in next_turn["user"].lower()
                        or next_turn["user"].lower() in suggestion.lower()
                    ):
                        print(
...
def show_suggestion_variety():
    ...
    for query, description in query_examples:
        ...
        suggestions = agent._generate_suggestions(
            query, "Sample response for demonstration purposes.", "demo_video"
        )
