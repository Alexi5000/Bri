...
async def test_agent_chat():
    ...
    try:
        ...
        response = await agent.chat(message="Hello, who are you?", video_id="test_video_123")
...
def test_memory_integration():
    ...
    try:
        ...
        memory.add_memory_pair(
            video_id=test_video_id, user_message="Test question", assistant_message="Test response"
        )
