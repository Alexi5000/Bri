...
from utils.logging_config import setup_logging, get_logger, get_performance_logger, get_api_logger
...
def test_performance_logging():
    ...
    perf_logger.log_execution_time(
        "object_detection", 0.05, success=False, video_id="test_video_123", error="Model not loaded"
    )
...
def test_api_logging():
    ...
    api_logger.log_api_call(
        "Groq", "/chat/completions", method="POST", status_code=200, execution_time=0.523
    )
