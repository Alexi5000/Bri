...
def test_tool_errors():
    ...
    message = ErrorHandler.handle_tool_error(
        "frame_extractor", error, available_tools=["audio_transcriber", "image_captioner"]
    )
    ...
    message = ErrorHandler.handle_tool_error(
        "audio_transcriber", error, available_tools=["image_captioner"]
    )
    ...
    message = ErrorHandler.handle_tool_error(
        "object_detector", error, available_tools=["image_captioner", "audio_transcriber"]
    )
    ...
    message = ErrorHandler.handle_tool_error(
        "unknown_tool", error, available_tools=["image_captioner"]
    )
...
def test_processing_errors():
    ...
    message = ErrorHandler.handle_processing_error(
        "video123", error, completed_steps=["frame extraction", "captioning"]
    )
